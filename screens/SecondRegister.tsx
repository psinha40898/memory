import {
  ...
  const SecondRegister: React.FC<Props> = (props) => {
    ...
    var objectA = {
      name: "lost blue pup",
      count: 1,
      message: "You think you chose the cutest one. You may never meet another.",
    ...
    var objectB = {
      ...
      count: 1,
      message:
        "Her invincibility is self proclaimed. You may never meet another.",
    ...
    var objectC = {
      name: "great dragon",
      count: 1,
      message: "You didn't think they were real, and you may never meet another.",
